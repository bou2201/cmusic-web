...
export function ViewPlaylistItem({ playlist }: { playlist: Playlist }): JSX.Element {
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-1 px-2 rounded-md transition-all hover:bg-neutral-800">
      <Link href={`${Routes.Playlist}/${playlist.id}`} className="flex items-center gap-3 flex-1">
      ...
      <Button
        className="transition-all rounded-full w-8 h-8 shrink-0 hover:bg-primary-pink"
